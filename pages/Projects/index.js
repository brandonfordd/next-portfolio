      ...
      <div className="card customCard">
        ...
        <div className="card-footer">
          <div className="text-center mt-auto">
            ...
            <a target="_blank" rel="noreferrer" href="https://github.com/AustinJoo97/Pandoras-Box" className="btn btn-secondary btn-lg  custom-length-sm" role="button" aria-pressed="true"><i className="fas fa-window-maximize"></i></a>
          </div>
        </div>
      </div>
