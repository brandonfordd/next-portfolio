  ...
  return (
    ...
    <div className="card customCard">
      ...
      <div className="card-body main-card-body d-flex flex-column">
        ...
        <p className="card-text h5">Full-stack application following MVC paradigm for creating, updating, sorting and deleting patient records. Below are the links for the GitHub repository and webpage!</p>
      </div>
    ...
    <Image className="card-img-top main-img-height" src="/assets/images/moivenight_screenshot.png" alt="moivenightdoneright" layout="responsive" width={6} height={3.7} />  
      <div className="card-body main-card-body d-flex flex-column">
        ...
        <p className="card-text h5">This assignment was my first group Project! Using <b className="html">html</b>, <b className="css">css</b>, and <b className="javascript">javascript</b> we made a movie catalog! Below are the links for the GitHub repository and webpage!</p>
      </div>
      <div className="card-footer">
        <div className="text-center mt-auto">
